...
export function ModernHeader() {
  return (
    <header className="fixed top-0 left-0 right-0 z-30 bg-white/80 backdrop-blur-xl border-b border-gray-200/60 shadow-sm">
        ...
        <div className="hidden md:flex items-center flex-1 max-w-md">
          <div className="relative w-full">
            ...
            <Input
              ...
              className="pl-10 pr-4 py-2 bg-gray-50/80 border-gray-200 rounded-xl focus:bg-white transition-colors"
            />
          </div>
        </div>
