        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-4">
          <div className="flex items-center gap-2 w-full sm:w-auto">
            ...
            <div className="flex-1">
              <h1 className="text-lg sm:text-xl font-bold tracking-tight">Metas</h1>
              ...
              <CardContent className="flex flex-col items-center justify-center py-6 sm:py-10">
                <div className="text-center space-y-3 max-w-md mx-auto px-3 sm:px-4">
                  ...
                  <div className="space-y-1">
                    <h3 className="text-base font-semibold">Nenhuma meta definida</h3>
                    <p className="text-muted-foreground text-xs sm:text-sm">
                      Comece definindo suas primeiras metas de negócio para acompanhar o crescimento.
                    </p>
                  </div>
                </div>
              </CardContent>
